...
processor = AutoProcessor.from_pretrained("linhtql/wav2vec2-base-vietnamese-250h")
model = AutoModelForCTC.from_pretrained("linhtql/wav2vec2-base-vietnamese-250h")
